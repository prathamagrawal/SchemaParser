...
class SchemaModelForm(forms.ModelForm):
    class Meta:
        ...
        labels = {"title": "Schema Title:", "description": "Schema Description:"}
        widgets = {
...
PropertiesFormset = modelformset_factory(
    ...
    widgets={
        "propertyTitle": forms.TextInput(
            attrs={"class": "form-control", "placeholder": "Enter Property title here"}
        ),
        "propertyDescription": forms.TextInput(
            attrs={
                "class": "form-control",
                "placeholder": "Enter Property Description here",
            }
        ),
        "propertyDataType": forms.Select(
            attrs={
                "class": "form-control",
            }
        ),
        "propertyRequired": forms.CheckboxInput(
            attrs={
